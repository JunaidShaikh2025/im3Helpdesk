        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AttendeeEmails = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "audio"),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "missed"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketCustomFieldValues_CustomFields_CustomFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_ReceiverId_Status",
                table: "CallLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCustomFieldValues_CustomFieldId",
                table: "TicketCustomFieldValues",
                column: "CustomFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketCustomFieldValues_TicketId",
                table: "TicketCustomFieldValues",
                column: "TicketId");
